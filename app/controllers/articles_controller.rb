class ArticlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @article.save
        format.html { redirect_to [@article.blog, @article], notice: 'Article was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @article.update(article_params)
        format.html { redirect_to [@article.blog, @article], notice: 'Article was successfully updated.' }
